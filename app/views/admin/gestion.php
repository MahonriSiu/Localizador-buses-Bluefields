...
<body>
    ...
    <div class="contenedor">
        <div class="tarjeta">
            ...
            <p style="font-size: 13px; color: #6b6255; margin-bottom: 12px;">Se guarda automaticamente al cambiar los campos.</p>
        ...
        <div class="tarjeta">
            ...
            <p style="font-size: 13px; color: #6b6255; margin-bottom: 12px;">
                Las paradas ya no se crean aqui: ahora se marcan directamente en el mapa desde "Marcar Eventos".
            </p>
