...
<head>
    ...
    <title>MiBus - Mapa de Mis Buses</title>
...
<body class="pagina-mapa-interno">
    ...
    <div class="mapa-interno-contenedor">
        ...
        <div class="mapa-interno-leyenda" id="leyenda-mapa">
            <span class="pulso-vivo"></span> Cargando tus buses...
        </div>
    </div>
    ...
    <script>
        ...
        async function actualizarBuses() {
            ...
            document.getElementById("leyenda-mapa").innerHTML =
                "<span class='pulso-vivo'></span> " + resultado.buses.length + " buses tuyos - " + transmitiendo + " transmitiendo ahora";
        }
