...
<body>
    ...
    <script>
        ...
        async function cargarUsuarios() {
            const resultado = await llamarApi(URL_BASE + "/auditor_obtener_usuarios_finales.php", {});
        ...
        async function cargarHistorial() {
            const resultado = await llamarApi(URL_BASE + "/auditor_obtener_historial_accesos.php", {});
